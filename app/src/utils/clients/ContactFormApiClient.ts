import { HttpMethod, IContactForm, IContactFormClient, IReport } from '@/models';
...
export class ContactFormApiClient implements IContactFormClient {
    ...
    listContactForms(paginationToken?: string | undefined): Promise<{ contactForms: IContactForm[]; paginationToken: string | undefined; }> {
        throw new Error('Method not implemented.');
    }
    putContactForm(contactForm: IContactForm): Promise<IContactForm | undefined> {
        throw new Error('Method not implemented.');
    }
    listContactFormsByStatus(status: string, ascending?: boolean | undefined, paginationToken?: string | undefined): Promise<{ contactForms: IContactForm[]; paginationToken: string | undefined; }> {
        throw new Error('Method not implemented.');
    }
    /** Create report */
